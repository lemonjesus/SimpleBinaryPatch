...
struct binary_patch {
	len_t    bin_len;     // Length of the raw binary data, uint32_t for portability
	len_t   *diff_start;  // Array of indexes for the starts of the differing sections
	len_t   *diff_stop;   // Array of indexes for the ends of the differing sections
	len_t    diff_len;    // Lenth of the 2 above arrays, they should be the same
...
/**
 * Applies the patch generated by gen_patch().  Stops and returns if an error is encountered.
 *
